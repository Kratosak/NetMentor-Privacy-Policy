...
public final class HomeViewModel_Factory implements Factory<HomeViewModel> {
  ...
  public HomeViewModel_Factory(Provider<QuizRepository> repositoryProvider) {
  ...
  public static HomeViewModel_Factory create(Provider<QuizRepository> repositoryProvider) {
    return new HomeViewModel_Factory(repositoryProvider);
  }

  public static HomeViewModel newInstance(QuizRepository repository) {
